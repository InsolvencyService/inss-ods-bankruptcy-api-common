...
namespace INSS.ODS.Bankruptcy.API.Common.UnitTests
{
    ...
    public class PartnershipDetailTests
    {
        ...
        public void PartnershipDetailNoOtherNamesValidModel()
        {
            ...
            validator.ShouldNotHaveValidationErrorFor(x => x.BusinessName, partnershipDetail);
            validator.ShouldNotHaveValidationErrorFor(x => x.TradingStartedDate, partnershipDetail);
            validator.ShouldNotHaveValidationErrorFor(x => x.BusinessType, partnershipDetail);
        ...
        public void PartnershipDetailNoOtherNamesInValidModel()
        {
            ...
            validator.ShouldHaveValidationErrorFor(x => x.BusinessType, partnershipDetail);
            validator.ShouldNotHaveValidationErrorFor(x => x.TradingStartedDate, partnershipDetail);
            validator.ShouldNotHaveValidationErrorFor(x => x.BusinessName, partnershipDetail);
