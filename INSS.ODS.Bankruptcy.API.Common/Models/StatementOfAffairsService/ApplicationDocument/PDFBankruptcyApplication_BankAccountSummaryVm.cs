...
{
    [Serializable]
    public class PDFBankruptcyApplication_BankAccountSummaryVm
    {
        public PDFBankruptcyApplication_BankAccountSummaryVm()
        {

        }

        public PDFBankruptcyApplication_BankAccountSummaryVm(BankAccountDetails accountDetails, List<JointAccountOwner> jointAccountOwners)
        {
