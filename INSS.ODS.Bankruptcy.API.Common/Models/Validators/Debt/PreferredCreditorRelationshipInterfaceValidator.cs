    ...
    public class PreferredCreditorRelationshipInterfaceValidator : AbstractValidator<IPreferredCreditorRelationship>
    {
        public PreferredCreditorRelationshipInterfaceValidator()
        {
            RuleFor(x => x.RelationshipToYou)
              ...
              .NotEmpty()
              .WithMessage(PreferredCreditorRelationshipResources.Debt_PreferredCreditorRelationship_Relationship_Error_Required)
              .Must((o, relationshipToYou) => OtherFieldValidationHelper.OtherFieldNotEmpty(relationshipToYou, o.RelationshipToYouOther))
              .WithMessage(PreferredCreditorRelationshipResources.Debt_PreferredCreditorRelationship_RelationshipOther_Error_Required)
              ...
              .WithMessage(PreferredCreditorRelationshipResources.Debt_PreferredCreditorRelationship_RelationshipOther_Error_TooShort)
              ...
              .WithMessage(PreferredCreditorRelationshipResources.Debt_PreferredCreditorRelationship_RelationshipOther_Error_TooLong);
        }
    }
}
