    ...
    public class DebtDetailValidator : AbstractValidator<IDebtDetail>
    {
        public DebtDetailValidator()
        {
            ...
            RuleFor(x => x.ReasonsForDebt)
             ...
             .WithLocalizedMessage(() =>DebtDetailsResources.Creditors_DebtDetails_Reason_Error_Mandatory);

            RuleFor(x => x.ReasonsForDebt)
                .Must(x => false)
                .When(x => x.Other && x.RequiresReason)
                .Unless(x => !String.IsNullOrWhiteSpace(x.Other_Text))
                .WithLocalizedMessage(() => DebtDetailsResources.Creditors_DebtDetails_Reason_OtherText_NoOther);
            ...
            RuleFor(x => x.ReasonsForDebt)
                ...
                .Unless(x => x.Other)
                .WithLocalizedMessage(() => DebtDetailsResources.Creditors_DebtDetails_Reason_Error_OtherText);
            ...
            .NotNull()
            .WithLocalizedMessage(() => DebtDetailsResources.Creditors_DebtDetails_StartDate_Error_Mandatory)
            .NotEmpty()
            .WithLocalizedMessage(() => DebtDetailsResources.Creditors_DebtDetails_StartDate_Error_Mandatory);
          ...
          () => DebtDetailsResources.Creditors_DebtDetails_SeizedOrSoldAssets_Required);

            RuleFor(r => r.AttachmentOfEarnings)
          .NotNull()
          .WithLocalizedMessage(
          () => DebtDetailsResources.Creditors_DebtDetails_AttachmentOfEarnings_Required);
            ...
            RuleFor(x => x.ValidationHook)
               ...
               .WithLocalizedMessage(() => DebtDetailsResources.Creditors_DebtDetails_Recent_Action_Error);
        }
