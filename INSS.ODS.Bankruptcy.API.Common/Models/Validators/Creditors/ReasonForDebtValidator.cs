...
namespace INSS.ODS.Bankruptcy.API.Common.Models.Validators.Creditors
{
    public class ReasonForDebtValidator: AbstractValidator<IReasonForDebt>
    {
        public ReasonForDebtValidator()
        {
            ...
            //    .WithMessage(ReasonForDebtResources.Creditors_ReasonForDebt_Reason_Error_Mandatory);

            //RuleFor(x => x.ReasonForDebt_FieldsetStart)
            //    .Must(x => false)
            //    .When(x => x.Other)
            //    .Unless(x => !String.IsNullOrWhiteSpace(x.Other_Text))
            //    .WithMessage(ReasonForDebtResources.Creditors_ReasonForDebt_Reason_Error_OtherText);
           ...
           RuleFor(x => x.ReasonsForDebt)
                ...
                .WithMessage(ReasonForDebtResources.Creditors_ReasonForDebt_Reason_Error_Other_MinLength);
            ...
            RuleFor(x => x.ReasonsForDebt)
                ...
                .WithMessage(ReasonForDebtResources.Creditors_ReasonForDebt_Reason_Error_Other_MaxLength);
