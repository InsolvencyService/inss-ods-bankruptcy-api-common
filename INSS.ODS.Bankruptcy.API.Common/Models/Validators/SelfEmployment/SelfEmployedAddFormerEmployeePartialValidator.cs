...
{
    public class SelfEmployedAddFormerEmployeePartialValidator : AbstractValidator<ISelfEmployedAddFormerEmployeePartial>
    {

        public SelfEmployedAddFormerEmployeePartialValidator()
        {
