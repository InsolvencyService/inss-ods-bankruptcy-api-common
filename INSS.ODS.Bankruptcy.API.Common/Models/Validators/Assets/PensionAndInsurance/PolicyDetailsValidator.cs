    ...
    public class PolicyDetailsValidator : AbstractValidator<IPolicyDetail>
    {
        public PolicyDetailsValidator()
        {
            ...
            RuleFor(x => x.PolicyType)
                .NotNull()
                .WithMessage(PolicyProviderDetailsResources.PensionAndInsurance_PolicyProviderDetails_PolicyType_Error_Empty);
            ...
            RuleFor(x => x.PolicyType)
                ...
                .WithMessage(PolicyProviderDetailsResources.PensionAndInsurance_PolicyProviderDetails_PolicyType_TooLong_Or_Short);
            ...
            RuleFor(x => x.CommencementDate)
                ...
                .NotEmpty()
                .WithMessage(PolicyProviderDetailsResources.PensionAndInsurance_PolicyProviderDetails_CommencementDate_Error_Empty);

            RuleFor(x => x.PolicyReferenceNo)
                .Length(0, 30)
                .WithMessage(PolicyProviderDetailsResources.PensionAndInsurance_PolicyProviderDetails_PolicyReferenceNo_TooLong)
