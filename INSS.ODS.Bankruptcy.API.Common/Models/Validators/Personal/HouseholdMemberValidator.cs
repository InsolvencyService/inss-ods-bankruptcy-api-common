    ...
    public class HouseholdMemberValidator : CompositeValidator<IHouseholdMember>
    {
        public HouseholdMemberValidator()
        {
            ...
            RuleFor(x => x.AgeGroup)
                ...
                .NotNull()
                .WithMessage(AddHouseholdMemberResources.Personal_AddHouseholdMember_Age_Error_Empty)
                .NotEmpty()
                .WithMessage(AddHouseholdMemberResources.Personal_AddHouseholdMember_Age_Error_Empty)
                .Length(1, 8);
            ...
            RuleFor(x => x.Relationship)
                .Cascade(CascadeMode.StopOnFirstFailure)
                .NotNull()
                .WithMessage(AddHouseholdMemberResources.Personal_AddHouseholdMember_Relationship_Error_Empty)
                .NotEmpty()
                .WithMessage(AddHouseholdMemberResources.Personal_AddHouseholdMember_Relationship_Error_Empty)
                .Length(1, 39)
                .WithMessage(AddHouseholdMemberResources.Personal_AddHouseholdMember_RelationshipOther_Error_MaxLength)
            ...
            RuleFor(x => x.FinanciallyDependentOption)
                .Cascade(CascadeMode.StopOnFirstFailure)
                .NotNull()
                .WithMessage(AddHouseholdMemberResources.Personal_AddHouseholdMember_FinanciallyDependent_Error_Empty)
                .NotEmpty()
                .WithMessage(AddHouseholdMemberResources.Personal_AddHouseholdMember_FinanciallyDependent_Error_Empty);
        }
